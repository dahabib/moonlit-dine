                ...
                <div class="flex flex-wrap -m-12">
                    <div class="p-12 md:w-1/2 flex flex-col items-start">
                        ...
                        <div class="flex items-center flex-wrap pb-2 mb-1 mt-auto w-full">
                            <p class="text-red-800 text-lg font-bold inline-flex items-center content-center">$55</p>
                            <div className="rounded-3xl border border-gray-400 ml-2 px-4 space-x-2">
                                <button className="inline-block font-bold text-lg" onClick={() => decrease()}>-</button>
                                <p className="inline-block font-bold text-lg px-2">{quantity}</p>
                                <button className="inline-block font-bold text-lg" onClick={() => increase()}>+</button>
                            </div>
                        </div>
