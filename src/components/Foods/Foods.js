            ...
            <div class="container px-16 py-12 mx-auto">
                <div className="flex flex-wrap">
                    <div className="w-full">
                        <ul className="content-center mx-auto w-full flex mb-0 list-none flex-wrap pt-3 pb-4 flex-row" role="tablist">
                            {
                        ...
                        {console.log('Selected Category:', selectedCategory + 'Open Tab: ', openTab)}
                        {
                            selectedCategory && <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6">
                                <div className="px-4 py-5 flex-auto">
                                    <div className="tab-content tab-space">
                                        <div className={openTab === (category?.idCategory) ? "block" : "hidden"} id={category?.strCategory}>
